...
* 
* Javascript EncryptPost object.
* Client-side encryption/decryption for EncryptPost.class.php
* 
...
var EncryptPost = {
    ...
    init: function()
    {
        ...
        if (sessionStorage.getItem("aesk") === null){
            ...
            this.aeskeyElement.name = 'EncryptPost_key';
